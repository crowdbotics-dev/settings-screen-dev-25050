...
## Project Structure
    ...
    ├── settings_screen_dev_25050  # Django project configurations
...
1. Clone this repo and `cd settings_screen_dev_25050`
...
2. Clone this repo and `cd settings_screen_dev_25050`
